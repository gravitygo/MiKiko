Make the model better in getting the information about the categories.
Currency should match the current currency in settings
Recurring transactions should be undo-able till the first transaction. So from last transaction before it's completed, till the first transaction.
